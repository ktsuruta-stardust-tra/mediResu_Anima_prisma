...
export const ItemsAnyComp = ({ className, text = "お名前" }: Props): JSX.Element => {
  return (
    <div className={`inline-flex items-center gap-1.5 pl-5 pr-0 pt-5 pb-0 relative ${className}`}>
      ...
      <div className="inline-flex items-center justify-center px-1.5 py-0.5 relative flex-[0_0_auto] bg-[#909090] rounded-[10px] overflow-hidden">
