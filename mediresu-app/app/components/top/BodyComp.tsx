  ...
  return (
    ...
    <div className={`flex flex-col w-[335px] items-center gap-5 relative ${className}`}>
      ...
      <div className="inline-flex items-start justify-center gap-[15px] relative flex-[0_0_auto]">
        <div className="flex w-40 h-[60px] items-center justify-center gap-2.5 px-8 py-2.5 relative bg-[#d9d9d9] rounded-lg shadow-[0px_2px_2px_#00000040]">
          <img
        ...
        <div className="flex flex-col w-40 h-[60px] items-center gap-2.5 px-6 py-2.5 relative bg-[#d9d9d9] rounded-lg shadow-[0px_2px_2px_#00000040]">
