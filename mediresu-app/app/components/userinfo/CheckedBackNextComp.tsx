  ...
  return (
    <div className={`flex w-[230px] items-center justify-center gap-2.5 pt-5 pb-0 px-0 relative ${className}`}>
      ...
      {!isValid ?(
        ...
        <Link to={nextLink} className="flex w-[110px] h-10 items-center justify-center gap-1.5 px-[15px] py-2.5 relative bg-white rounded-[20px] border border-solid border-[#24b6ae]">
        
          <div className="relative w-fit mr-[-2.50px] [font-family:'Inter',Helvetica] font-bold text-[#24b6ae] text-sm tracking-[0] leading-[normal]">
            次へ
          </div>
          <img className="relative w-2 h-3" alt="Subtract" src="/img/userinfo/subtract-7-1.svg"/>
        </Link>
      )}
